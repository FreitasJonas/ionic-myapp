  ...
  drawComplete() {
   ...
   const objHash = this.testCrypto();
    ...
    this.jObj.forEach((element, index) => {
      ...
      var fullPath = "/myapp/" + element.nm_imagem;
